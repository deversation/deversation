...
def random_questions(user):
    ...
    b'Given 2 integers, a and b, return True if one of them is 10 or if their sum is 10. Otherwise return False.\n\n',
    ...
    prefix = Text.colored_text('💥YOUR CHALLENGE:💥\n\n', 'green')
